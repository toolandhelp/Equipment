...
; !function (window, undefined) {
    ...
    window.ParentHelper = {
        ...
        ShowDialogInfo: function (searchType, searchCode, DeptCode, searchProject) {
            ...
            var tb = $("#" + objId);
            if (!tb || !tb.length) {
                searchType === 1 ? this.BuilderStreetDetails(objId, searchCode, DeptCode, searchProject) : this.BuilderDeptDetails(objId, DeptCode, searchProject);
            } else {
                tb.appendTo($("#dvDialog"));
                layerWinIndx = MISSY.iShowDialog("dvDialog", "条块之间工作职责人员对接明细表");
            }
        },
