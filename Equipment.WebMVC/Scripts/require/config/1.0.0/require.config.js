...
require.config({
    ...
    paths: {
        ...
        "jquery.ztree.exhide":"zTree/3.5.24/jquery.ztree.exhide.min",
        ...
        "jquery.inputmask":"inputmask/jquery.inputmask", //已将global,dependencyLibs文件夹拷贝到Scripts文件夹中
        "inputmask": "inputmask/inputmask",
        "jquery.ipInput":"InputIp/jquery.ipInput"
       // "MeidaDMGrid": "MeidaDMGrid/MeidaDMGrid"
    },
    shim: {
        "jquery.ipInput": { deps: ["jquery"] },
        "jquery.ztree.exhide": { deps: ["jquery.ztree"]},
