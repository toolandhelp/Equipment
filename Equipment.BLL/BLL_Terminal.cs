...
{
    public class BLL_Terminal
    {
        #region dbContext
        public DbHelperEfSql<td_Terminal> dbContext { get; set; }
        public BLL_Terminal()
        {
            dbContext = new DbHelperEfSql<td_Terminal>();
        }
        #endregion

        #region 增改删 CUD Entity
        public bool AddOrUpdate(td_Terminal entity)
        {
            if (entity.ID < 1)
            {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public td_Terminal GetObjectById(int iId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IList<V_Terminal_Dept> GetObjectAll()
        {
            var service = new DbHelperEfSql<V_Terminal_Dept>();
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public V_Terminal_Dept GetObjectDeptById(int iId)
        {
            var service = new DbHelperEfSql<V_Terminal_Dept>();
        ...
        /// <returns></returns>
        public IList<td_Terminal> GetListByCondition(ConditionModel conditionItem)
        {
        ...
        /// <returns></returns>
        public IList<td_Terminal> GetPageList(int iPageIndex, int iPageSize, ref int iTotalRecord)
        {
        ...
        /// <param name="conditionItem"></param>
        /// <returns></returns>
        public IList<V_Terminal_Dept> GetPageListByCondition(int iPageIndex, int iPageSize, ref int iTotalRecord, ConditionModel conditionItem)
        {
            var service = new DbHelperEfSql<V_Terminal_Dept>();
