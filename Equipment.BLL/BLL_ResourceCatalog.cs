...
{
    public class BLL_ResourceCatalog
    {
        #region dbContext
        public DbHelperEfSql<td_ResourceCatalog> dbContext { get; set; }
        public BLL_ResourceCatalog()
        {
            dbContext = new DbHelperEfSql<td_ResourceCatalog>();
        }
        #endregion

        #region 增改删 CUD Entity
        public bool AddOrUpdate(td_ResourceCatalog entity)
        {
            if (entity.ID < 1)
            {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public td_ResourceCatalog GetObjectById(int iId)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public V_ResourceCatalog_Dept GetObjectDeptById(int iId)
        {
            var service = new DbHelperEfSql<V_ResourceCatalog_Dept>();
        ...
        /// </summary>
        /// <returns></returns>
        public IList<V_ResourceCatalog_Dept> GetObjectAll()
        {
            var service = new DbHelperEfSql<V_ResourceCatalog_Dept>();
        ...
        /// <returns></returns>
        public IList<td_ResourceCatalog> GetListByCondition(ConditionModel conditionItem)
        {
        ...
        /// <returns></returns>
        public IList<td_ResourceCatalog> GetPageList(int iPageIndex, int iPageSize, ref int iTotalRecord)
        {
        ...
        /// <param name="conditionItem"></param>
        /// <returns></returns>
        public IList<V_ResourceCatalog_Dept> GetPageListByCondition(int iPageIndex, int iPageSize, ref int iTotalRecord, ConditionModel conditionItem)
        {
            var service = new DbHelperEfSql<V_ResourceCatalog_Dept>();
