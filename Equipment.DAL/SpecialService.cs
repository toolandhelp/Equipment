...
namespace Equipment.DAL
{
    /// <summary>
    /// 特殊数据层，针对不完善的事情
    /// </summary>
    public class SpecialService : BaseServiceEf<equipmentEntities>
    {
        ...
        public bool AddImportNet(List<td_Network_1> list)
        {
            try
            {
                ...
                _context.td_Network_1.RemoveRange(_context.td_Network_1.ToList());
                _context.td_Network_1.AddRange(list);
                _context.SaveChanges();
                return true;
            }
            catch (Exception ex)
            {
                MessageLog.AddErrorLogDalSpecial("AddImportNet(网络情况导入)", ex.Message);
                return false;
            }
        }
        /// <summary>
        ...
        public bool AddImportSoft(List<td_GenuineSoftware_1> list)
        {
            try
            {
                if (list == null) return false;

                 _context.td_GenuineSoftware_1.RemoveRange(_context.td_GenuineSoftware_1.ToList());
                _context.td_GenuineSoftware_1.AddRange(list);
                _context.SaveChanges();
                return true;
            }
            catch (Exception ex)
            {
                MessageLog.AddErrorLogDalSpecial("AddImportSoft(软件情况导入)", ex.Message);
                return false;
            }
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public bool AddImportRoom(List<td_ComputerRoom_1> list)
        {
            try
            {
                if (list == null) return false;

                _context.td_ComputerRoom_1.RemoveRange(_context.td_ComputerRoom_1.ToList());
                _context.td_ComputerRoom_1.AddRange(list);
                _context.SaveChanges();
                return true;
            }
            catch (Exception ex)
            {
                MessageLog.AddErrorLogDalSpecial("AddImportRoom(机房情况导入)", ex.Message);
                return false;
            }
        }
        public bool AddImportRoom_sl(List<td_ComputerRoom_sbsl_1> list)
        {
            try
            {
                if (list == null) return false;

                _context.td_ComputerRoom_sbsl_1.RemoveRange(_context.td_ComputerRoom_sbsl_1.ToList());
                _context.td_ComputerRoom_sbsl_1.AddRange(list);
                _context.SaveChanges();
                return true;
            }
            catch (Exception ex)
            {
                MessageLog.AddErrorLogDalSpecial("AddImportRoom_sl(机房情况数量导入)", ex.Message);
                return false;
            }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public bool AddImportSecurity(List<td_Security_1> list)
        {
            try
            {
                if (list == null) return false;

                _context.td_Security_1.RemoveRange(_context.td_Security_1.ToList());
                _context.td_Security_1.AddRange(list);
                _context.SaveChanges();
                return true;
            }
            catch (Exception ex)
            {
                MessageLog.AddErrorLogDalSpecial("AddImportSecurity(安全情况导入)", ex.Message);
                return false;
            }
        }
        public bool AddImportSecurity_sl(List<td_Security_xxsl_1> list)
        {
            try
            {
                if (list == null) return false;

                 _context.td_Security_xxsl_1.RemoveRange(_context.td_Security_xxsl_1.ToList());
                _context.td_Security_xxsl_1.AddRange(list);
                _context.SaveChanges();
                return true;
            }
            catch (Exception ex)
            {
                MessageLog.AddErrorLogDalSpecial("AddImportSecurity_sl(安全情况数量导入)", ex.Message);
                return false;
            }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public bool AddImportService_1(List<td_Service_1> list)
        {
            try
            {
                if (list == null) return false;

                 _context.td_Service_1.RemoveRange(_context.td_Service_1.ToList());
                _context.td_Service_1.AddRange(list);
                _context.SaveChanges();
                return true;
            }
            catch (Exception ex)
            {
                MessageLog.AddErrorLogDalSpecial("AddImportService_1(物理服务器导入)", ex.Message);
                return false;
            }
        }
        public bool AddImportService_2(List<td_Service_2> list)
        {
            try
            {
                if (list == null) return false;

                 _context.td_Service_2.RemoveRange(_context.td_Service_2.ToList());
                _context.td_Service_2.AddRange(list);
                _context.SaveChanges();
                return true;
            }
            catch (Exception ex)
            {
                MessageLog.AddErrorLogDalSpecial("td_Service_2(虚拟服务器导入)", ex.Message);
                return false;
            }
